...
typedef struct
{
	rt_uint8_t LicenVaildY;
	rt_uint8_t LicenVaildM;
	rt_uint8_t LicenVaildD;
}LicenVailStatus;

typedef struct
{
	rt_uint8_t reserve[32];
	rt_uint8_t MotoDrvLNm[18];
	LicenVailStatus licenvaildate;
	rt_uint8_t QualifCerf[18];
	rt_uint8_t StandarRev[56];
	rt_uint8_t XORCheck;

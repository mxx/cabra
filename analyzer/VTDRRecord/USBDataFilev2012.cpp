...
void USBDataFilev2012::initMap()
{
	...
	if (DataBlockName.empty())
	{
		...
		DataBlockName[1] = "å½“å‰é©¾é©¶äººä¿¡æ¯";
		DataBlockName[2] = "å®žæ—¶æ—¶é—´";
		DataBlockName[3] = "ç´¯è®¡è¡Œé©¶é‡Œç¨‹";
		DataBlockName[4] = "è„‰å†²ç³»æ•°";
		DataBlockName[5] = "è½¦è¾†ä¿¡æ¯";
		DataBlockName[6] = "çŠ¶æ€ä¿¡å·é…ç½®ä¿¡æ¯";
		DataBlockName[7] = "è®°å½•ä»ªå”¯ä¸€æ€§ç¼–å·";
		DataBlockName[8] = "è¡Œé©¶é€Ÿåº¦è®°å½•";
		DataBlockName[9] = "ä½ç½®ä¿¡æ¯è®°å½•";
		DataBlockName[0x10] = "äº‹æ•…ç–‘ç‚¹è®°å½•";
		DataBlockName[0x11] = "è¶…æ—¶é©¾é©¶è®°å½•";
		DataBlockName[0x12] = "é©¾é©¶äººèº«ä»½è®°å½•";
		DataBlockName[0x13] = "å¤–éƒ¨ä¾›ç”µè®°å½•";
